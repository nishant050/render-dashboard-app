...
const defaultMonthlyPlan = () => ({
    incomes: [
        { name: 'Primary Salary', amount: 60000 },
        { name: 'Secondary Income', amount: 15000 }
    ],
    expenses: [
        { name: 'Rent & Housing', amount: 16000, store: 'Bank Account' },
        { name: 'Groceries & Supplies', amount: 9000, store: 'Debit Card' },
        { name: 'Utilities & Bills', amount: 3500, store: 'Bank Account' },
        { name: 'Fuel & Transport', amount: 2500, store: 'Debit Card' },
        { name: 'Health & Wellness', amount: 3000, store: 'Credit Card' },
        { name: 'Dining & Leisure', amount: 4000, store: 'Credit Card' },
        { name: 'Emergency Savings', amount: 10000, store: 'Bank Account' },
        { name: 'Monthly Investments', amount: 15000, store: 'Bank Account' }
    ],
    stores: [
        { name: 'Bank Account', amount: 44500, purpose: 'Fixed expenses, bills and SIPs' },
        { name: 'Debit Card', amount: 11500, purpose: 'Groceries and daily fuel' },
        { name: 'Credit Card', amount: 7000, purpose: 'Health, leisure, and shopping' }
    ],
    investments: [
        { fund: 'Broad Market Index Fund SIP', amount: 7500, purpose: 'Long-term retirement' },
        { fund: 'Liquid Reserve Fund SIP', amount: 4500, purpose: 'Emergency fund cushion' },
        { fund: 'Balanced Hybrid Fund SIP', amount: 3000, purpose: 'Medium-term wealth building' }
    ],
    goals: [
        { name: 'Emergency Reserve (6 Months)', expectedAmount: 300000, years: 2, interestRate: 7, monthlyEmi: 11600, fund: 'Liquid Reserve Fund', important: true },
        { name: 'Retirement Corpus', expectedAmount: 10000000, years: 25, interestRate: 12, monthlyEmi: 5300, fund: 'Broad Market Index Fund', important: true },
        { name: 'Home Renovation / Downpayment', expectedAmount: 800000, years: 4, interestRate: 9, monthlyEmi: 13900, fund: 'Balanced Hybrid Fund', important: false }
    ]
});
